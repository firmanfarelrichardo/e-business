<x-layouts.app title="Katalog Produk ATK - Sinergi">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        <div class="mt-8 flex flex-wrap gap-2">
            <span class="px-4 py-2 bg-white text-slate-600 text-xs font-semibold rounded-lg shadow-sm border border-slate-100 cursor-pointer hover:bg-brand-primary hover:text-white hover:border-brand-primary transition-colors">#NewProduct</span>
            <span class="px-4 py-2 bg-white text-slate-600 text-xs font-semibold rounded-lg shadow-sm border border-slate-100 cursor-pointer hover:bg-brand-primary hover:text-white hover:border-brand-primary transition-colors">#ClearanceSale</span>
            <span class="px-4 py-2 bg-white text-slate-600 text-xs font-semibold rounded-lg shadow-sm border border-slate-100 cursor-pointer hover:bg-brand-primary hover:text-white hover:border-brand-primary transition-colors">#BestSeller</span>
            <span class="px-4 py-2 bg-white text-slate-600 text-xs font-semibold rounded-lg shadow-sm border border-slate-100 cursor-pointer hover:bg-brand-primary hover:text-white hover:border-brand-primary transition-colors">#MostViewed</span>
        </div>
        ...
        <div class="mt-6 flex flex-wrap gap-4 items-center mb-12">
            @foreach(['Joyko', 'Kenko', 'SDI', 'Faber Castell', 'Standard', 'Snowman', 'Zebra'] as $brand)
                <div class="bg-white px-4 py-2 rounded-lg shadow-sm border border-slate-100 flex items-center justify-center opacity-70 hover:opacity-100 cursor-pointer transition-opacity">
