                ...
                <x-ui.glass-card variant="dark"
                    ...
                    <div
                        ...
                        <div class="bg-white/20 backdrop-blur-md rounded-xl p-4 border border-white/30 text-center">
                            <h3 class="text-white font-bold text-2xl mb-1">{{ $activeCategoryName }}<br>Kebutuhan Anda.</h3>
                            <p class="text-white/80 text-sm">Terbaik untuk kebutuhan Anda.</p>
                        </div>
                    </div>
                </x-ui.glass-card>
            </div>
